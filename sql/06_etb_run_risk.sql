...
(
    SELECT DISTINCT ITEMNMBR, PRIME_VNDR, Construct
...
deficit_rows AS
(
    SELECT        p.ITEMNMBR, p.PRIME_VNDR, p.Demand_Due_Date, p.Deficit_Qty, p.WFQ_Extended_Status, 
...
with_threat AS
(
    SELECT        d.ITEMNMBR, d.PRIME_VNDR, d.Threatened_Clients, d.Client_Exposure_Count, d.First_Stockout_Date, d.Total_Deficit_Qty, d.WFQ_Dependency_Flag, 
...
SELECT DISTINCT ITEMNMBR, PRIME_VNDR, Threatened_Clients, Client_Exposure_Count, First_Stockout_Date, Days_To_Stockout, Total_Deficit_Qty, WFQ_Dependency_Flag, Schedule_Threat, LeadDays
FROM            with_threat;
