CREATE VIEW dbo.ETB_SUPPLY_ACTION AS
-- ============================================================================
-- VIEW: ETB_SUPPLY_ACTION
...
/*
================================================================================
ETB_SUPPLY_ACTION — Supply Action Recommendations and PO Timing (View 5)
================================================================================
Purpose:
...
Change Log:
  ...
  2026-03-06: Fix Status_Explanation silent-drop bug — column was computed in
              WithInventory but not carried through ETB_WC_INV, Demand_Ledger,
              or WFQ_Extended explicit column lists, causing
              "Invalid column name 'Status_Explanation'" at runtime.
  2026-03-06: Renamed from ETB_PAB_SUPPLY_ACTION to ETB_SUPPLY_ACTION.
================================================================================
*/
...
(
    SELECT
        ...
        5  AS Urgent_PO_Days,
        10 AS Warning_PO_Days,
        3  AS WFQ_Priority_Window_Days
),
-- ============================================================================
...
-- ============================================================================
-- joined: Core assembly with UNASSIGNED vendor fallback
-- ============================================================================
joined AS
(
    SELECT
...
-- ============================================================================
-- ledger_ranked: Manufacturing ledger
-- ============================================================================
ledger_ranked AS
(
    SELECT
...
-- ============================================================================
-- Flags: Suppress_Stale, Suppress_Fence
-- ============================================================================
Flags AS
(
    SELECT
...
-- ============================================================================
-- WFQ_Allocated: Per-demand-row WFQ influx
-- ============================================================================
WFQ_Allocated AS
(
    SELECT
