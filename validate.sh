...
# CP-3: Dependency chain — all 7 active sql/ views present
echo ""
...
# CP-4: sql/ is the canonical source — all 7 active views present and non-empty
echo ""
echo "[CP-4] sql/ canonical source integrity (all 7 active views present and non-empty)"
for n in 01 02 03 04 05 10 11; do
